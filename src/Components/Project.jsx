    ...
    >
      ...
      <div>
        {projectDetails.map((project) => {
          return (
            <div className="flex justify-between flex-wrap md:flex-nowrap even:flex-row-reverse p-2 ">
              ...
              <div className="flex flex-col  justify-center items-start m-2">
                ...
                <p>
                  {project.techStack.map((tech) => (
                    <span className="m-2 text-lg font-semibold text-fontPurple">
                      {tech}
                    </span>
                  ))}
                </p>
                <a
                  href={project.links}
                  className=" hover:text-fontPurple cursor-pointer text-3xl m-2"
                >
                  {<TbBrandGithub />}
                </a>
              </div>
